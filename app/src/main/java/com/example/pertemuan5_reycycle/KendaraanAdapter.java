...
public class KendaraanAdapter extends RecyclerView.Adapter<KendaraanAdapter.MakananViewHolder> {
    String data1[], data2[], data3[];
    int images[];
    Context context;
    public KendaraanAdapter(Context ct, String s1[], String s2[], String s3[], int  img[]){
        context = ct;
        data1 = s1;
        data2 = s2;
        data3 = s3;
    ...
    @NonNull
    @Override
    public KendaraanAdapter.MakananViewHolder
    ...
    @Override
    public void onBindViewHolder(@NonNull KendaraanAdapter.MakananViewHolder holder, int position) {
